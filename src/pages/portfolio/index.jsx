...
export default function index() {
    ...
    return (
        <Page>
            <a href="https://api.whatsapp.com/send?phone=62882005295050&text=Assalamualaikum%20mas%20Ulil,%20Saya%20berminat%20menggunakan%20jasa%20Web%20anda,%20bisa%20tolong%20dibantu?" style="
position: fixed;
width: 50px;
height: 50px;
bottom: 32px;
...
display: flex;
align-items: center;
justify-content: center;" target="_blank">
<div style="height: 33px;width: 33px;display: flex;    margin-left: 2px;
margin-top: 2px;">
