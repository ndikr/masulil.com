        ...
        <Section className={`relative`}>
            ...
            <div className='flex flex-col md:flex-row mb-44 2xsm:mb-52' >
                <div className='w-full text-center flex flex-col'>
                    ...
                    <p className={`subheading text-xl max-w-[520px] md:text-2xl md:max-w-[620px] lg:text-3xl lg:max-w-[800px] self-center ${transitionClasses2}`} ref={ref2}>Dapatkan Settingan Terbaik untuk Web Bisnis Anda Bisa Tampil di Halaman #1 Google dengan Jasa Rp100.000 /Minggu</p>
                </div>
            </div>
